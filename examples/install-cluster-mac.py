from scaleio import im
from scaleio import scaleioobject as sioobj
...
# LOGIN TO SCALEIO IM #
#######################
imconn = im.Im("https://192.168.102.2","admin","Scaleio123!!",verify_ssl=False) # "Password1!") # HTTPS must be used as there seem to be an issue with 302 responses in Requests when using POST
imconn._login()
